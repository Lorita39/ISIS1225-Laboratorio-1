...
1. [App:](./App) Folder with aplication Python scripts. In here the students implement their code to complete the laboratory instructions.
...
- Implement the missing functions according to the laboratory instructions at [App](./App) folder.
...
- [Andrés Rodriguez][afrodriguezm1-url] is a contributor and developed examples and tutorials for the library.
